...
const SPOTLIGHTS = [
  {
    ...
    media: { type: 'image-link', src: 'assets/chelsea-vowel-indigenous-learns.png?v=2', href: 'https://courses.apihtawikosisan.com/', orientation: 'landscape', caption: 'courses.apihtawikosisan.com', alt: 'Chelsea Vowel — Indigenous Learns: Welcome to mâci-nêhiyawêtân' },
  ...
  },
  {
    ...
    media: { type: 'image', src: 'assets/churchill-square-sound-exhibit.jpg?v=2', alt: 'Visitors at the ECAMP pop-up sound exhibit in Churchill Square — listeners with headphones at a fountain-side table.' },
...
const STAFF = [
  ...
  ["Jessica Johns", "Indigenous Initiatives Lead, FIRE (Former Staff)"],
  ...
  ["Carl Paolo Hernandez", "Community Engagement Assistant (Joined 2026)"],
  ["Jess Sebastiano", "Grants Administrator"],
  ["Fabiola Munoz", "Administrative Assistant (Former Staff)"],
